...
현재 전체적으로 알고리즘 빼곤 모든게 부족하다고 판단하였습니다. 다른 공부를 위해 원래는 매주 2문제 풀이가 기본이었으나, 이 날 이후부터 매주 __최소 1문제__ 풀이로 변경합니다. 최소 1문제 풀이지만 컨디션에 따라 더 많이 풀 수도 있습니다.

## 서문
이 레퍼지토리는 매주 최소 알고리즘 문제 1문제를 풀고 복기하는 과정을 기록한 저장소입니다. `2주 간격으로 한 주는 문제 풀이, 한 주는 복기하는 방식으로 진행됩니다.` 너무 쉬운 문제로 구성돼 있으면 복기 주는 생략할 수 있습니다.
