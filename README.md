...
## 이 프로젝트는 종료합니다.
- 기간: `2022-01-3주차` ~ `2022-05-2주차`
> Problem Solving에 권태감을 느껴 이 프로젝트를 시작하였습니다. 그동안 이 프로젝트를 하면서 Problem Solving이 습관화되고 나 자신이 변화된 것을 느낄 수 있었습니다. 이제부터는 이 프로젝트에 묶여있지 않고 자유롭게 Problem Solving을 즐기려 합니다. 혹시나 이 프로젝트를 보시거나 응원해주셨던 분 모두 감사합니다.
...
- [골4-알파벳](https://www.acmicpc.net/problem/1987)
  - [소스코드](https://github.com/jh2song/problem-solving/blob/master/PS/boj_1987.cpp)
...
※ 5월 3주차
- [L2-구명보트](https://programmers.co.kr/learn/courses/30/lessons/42885)
  - [소스코드](https://github.com/jh2song/problem-solving/blob/master/PS/prog_%EA%B5%AC%EB%AA%85%EB%B3%B4%ED%8A%B8.cpp)
